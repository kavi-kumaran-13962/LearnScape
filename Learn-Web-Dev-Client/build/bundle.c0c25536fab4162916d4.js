...
*/ var r =
  ...
  function (e, t, n) {
            ...
            i
              ? (er &&
                  ...
                  (ar || i !== nr.compositionStart
                    ...
                    : ((jn = "value" in (Dn = r) ? Dn.value : Dn.textContent),
                      (ar = !0))),
    ...
    function fr(e, t, n) {
      return (
        ((e = Hn.getPooled(sr.change, e, t, n)).type = "change"), z(n), Fn(e), e
      );
    }
    var dr = null,
      pr = null;
    ...
    function Bo(e) {
      return null === Ao ? ((Ao = [e]), (Fo = Eo(Po, Ko))) : Ao.push(e), Mo;
    }
    function Qo() {
      if (null !== Fo) {
        var e = Fo;
    ...
    function Ko() {
      if (!Do && null !== Ao) {
        ...
        try {
          ...
          throw (null !== Ao && (Ao = Ao.slice(e + 1)), Eo(Po, Qo), t);
        } finally {
          Do = !1;
        }
      }
    ...
    function qi(e, t, n, r, o, i) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (ji.current = null === e || null === e.memoizedState ? ya : ga),
        (e = n(r, o)),
        t.expirationTime === $i)
      ) {
        i = 0;
              ...
              : ((n = null !== r),
                ...
                n &&
                  ...
                  0 != (1 & Ai.current)
                    ? _l === wl && (_l = xl)
                    : ((_l !== wl && _l !== xl) || (_l = kl),
                      0 !== zl && null !== Tl && (Mu(Tl, Cl), Iu(Tl, zl)))),
                (n || r) && (t.effectTag |= 4),
                null)
          );
        case 4:
    ...
    function Yl(e, t) {
      ...
      return (
        null !== o && (Tl === o && (au(t), _l === kl && Mu(o, Cl)), Iu(o, t)), o
      );
    }
    function Xl(e) {
    ...
    function Jl(e, t) {
      if (((Bl = 0), t)) return Lu(e, (t = Ql())), Gl(e), null;
      var n = Xl(e);
      if (0 !== n) {
    ...
    function pu(e, t) {
      ...
      if (
        ...
        (Qt = !!hn), (vn = hn = null), (e.current = n), (Ll = o);
        do {
          try {
            for (w = e; null !== Ll; ) {
              var E = Ll.effectTag;
    ...
    function yu(e, t, n) {
      ci(e, (t = ml(e, (t = Ja(n, t)), 1073741823))),
        ...
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              ci(n, (e = hl(n, (e = Ja(t, e)), 1073741823))),
    ...
    function bu(e, t, n) {
      ...
      null !== r && r.delete(t),
        Tl === e && Cl === n
          ? _l === kl || (_l === xl && 1073741823 === Ol && Uo() - Il < 500)
            ? nu(e, Cl)
            : (Ml = !0)
          : zu(e, n) &&
      ...
      (t.unstable_scheduleCallback = function (e, n, a) {
        ...
        return (
          ...
          u > l
            ? ((e.sortIndex = u),
              S(N, e),
              null === C(O) && e === C(N) && (A ? i() : (A = !0), o(D, u - l)))
            : ((e.sortIndex = a), S(O, e), L || I || ((L = !0), r(j))),
          e
        );
      }),
  ...
  function (e, t, n) {
    ...
    function E(e) {
      ...
      var C = b();
      function _(e) {
        u(j, e), (j.length = n.length), C.notifyListeners(j.location, j.action);
      }
      function P(e) {
        (function (e) {
          return (
            ...
            if (e) {
              ...
              if (r)
                if ((n.pushState({ key: i, state: a }, null, t), l))
                  ...
                  var u = M.indexOf(j.location.key),
                    c = M.slice(0, u + 1);
    ...
    function P(e) {
      ...
      var k = b();
      function E(e) {
        u(j, e), (j.length = t.length), k.notifyListeners(j.location, j.action);
      }
      var P = !1,
        O = null;
      function N() {
          ...
          k.confirmTransitionTo(n, "PUSH", o, function (e) {
            if (e) {
              ...
              if (C() !== r) {
                ...
                var o = I.lastIndexOf(y(j.location)),
                  i = I.slice(0, o + 1);
                i.push(t), (I = i), E({ action: "PUSH", location: n });
              } else E();
            }
          });
        },
          ...
          k.confirmTransitionTo(n, "REPLACE", o, function (e) {
            if (e) {
              var t = y(n),
                r = s(l + t);
              C() !== r && ((O = t), _(r));
              var o = I.indexOf(y(j.location));
              -1 !== o && (I[o] = t), E({ action: "REPLACE", location: n });
            }
          });
        },
        go: L,
    ...
    var J = G(function (e, t) {
      ...
      return (c.ref = (X !== G && t) || n), o.a.createElement("a", c);
    });
    ...
    te(function (e, t) {
      ...
      return o.a.createElement(A.Consumer, null, function (e) {
        ...
        var n = p || e.location,
          ...
          x = w && w.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1"),
          k = x
            ? U(n.pathname, { path: x, exact: s, sensitive: m, strict: h })
            : null,
          E = !!(f ? f(k, n) : k),
          T = E
            ? (function () {
          ...
          S = E ? u({}, v, {}, l) : v,
          C = u(
            { "aria-current": (E && r) || null, className: T, style: S, to: i },
            b
          );
        return (
          ee !== te ? (C.ref = t || g) : (C.innerRef = g),
          o.a.createElement(Z, C)
        );
      });
    });
    var ne = n.p + "5402828b57fea0b8f1a7951f646492c3.png",
      re = n(9),
      oe = n.n(re);
    n(15);
    function ie(e) {
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        "div",
                        { className: "Auth__form--logoText" },
                        o.a.createElement(
                          "h3",
                          { className: "Auth__form--logotxt" },
                          "Learn Web Dev"
                        )
                      )
                    ),
                    o.a.createElement(
                      ...
                      o.a.createElement("label", { for: "email" }, "Email"),
    ...
    function pe() {
      return o.a.createElement(
        ...
        o.a.createElement(
          "switch",
          null,
          o.a.createElement($, { path: "/", component: de })
        )
      );
    }
    a.a.render(
      o.a.createElement(K, null, o.a.createElement(pe, null)),
